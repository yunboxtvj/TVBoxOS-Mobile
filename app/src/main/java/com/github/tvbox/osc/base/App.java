...
public class App extends MultiDexApplication {
    ...
    private void initParams() {
        ...
        putDefault(HawkConfig.IJK_CACHE_PLAY,true);           //IJK缓存: true=开启, false=关闭
        putDefault(HawkConfig.API_URL, "https://agit.ai/Yoursmile7/TVBox/raw/commit/eee1948ec7d0723a464411b1e63e1cf7145c9a2f/XC.json");
        //内置源接口
